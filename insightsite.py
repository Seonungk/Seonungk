...
image_path = "https://oopy.lazyrockets.com/api/v2/notion/image?src=https:%2F%2Fs3-us-west-2.amazonaws.com%2Fsecure.notion-static.com%2F5115780a-481e-4761-95c4-82aadf028886%2FKakaoTalk_20220717_175503399_01.png&blockId=f5e18d99-663c-4f47-a767-dbe29d5ec170&width=256"
# 이미지 데이터를 가져옴
...
if response.status_code == 200:
    ...
    st.chat_message("assistant").write('하이')
    ...
    if prompt := st.chat_input("왠만하면 모를텐데 일단 물어보슈"):
